#!/usr/bin/python3
"""
the route that handles the State objects and operations
"""
...
def city_by_state(state_id):
    """
    retrieves all the City objects from a specific state
...
def city_put(city_id):
    """
    updates the specific City objects by ID
    :param city_id: city object ID
