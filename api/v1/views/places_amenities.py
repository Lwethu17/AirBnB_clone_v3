#!/usr/bin/python3
"""
teh route that handles place and amenities linking
"""
...
def unlink_amenity_from_place(place_id, amenity_id):
    """
    unlinks the amenity in a place
...
def link_amenity_to_place(place_id, amenity_id):
    """
    links the amenity with a place
    :param place_id: place id
    :param amenity_id: amenity id
    :return: return Amenity object added or error
    """
